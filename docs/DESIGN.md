...
**Scope:** This document applies to the **customer storefront only**. For the admin panel UI, see [DESIGN_ADMIN.md](DESIGN_ADMIN.md).

Use the design system above for all storefront UI you generate.